...
class Farmaco:
    """
    Classe che rappresenta un farmaco estratto dal sito
    [AIFA](https://farmaci.agenziafarmaco.gov.it/bancadatifarmaci/).
    """
    ...
    def from_json_aifa(
        ...
        """
        Crea un oggetto `Farmaco` dal JSON preso dal sito
        [AIFA](https://farmaci.agenziafarmaco.gov.it/bancadatifarmaci/)
        """
        return Farmaco(
    ...
    def from_json(
        ...
        """
        return Farmaco(
            codice_farmaco, descrizione_farmaco, ditta, url_fi, principio_attivo, fi
        )
